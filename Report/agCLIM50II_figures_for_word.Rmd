...
# Create database for plotting
sel <- c("AGR_PROD", "CRP_AREA", "AGR_XPRP", "LSP_XPRP", "AGR_ECH4", "AGR_EN2O", "TOT_GDPT", "TOT_POPT", "LSP_AREA", "AGR_EMIS", "YEXO_CRP/TOT/LSP for baseline", "CALO_LSP/CRP/TOT", "CALO for all regions (14) for base and base-D")
